...
describe("<App />", () => {
  beforeAll(() => {
    ...
    process.env.REACT_APP_API_KEY = "eeb11b133540ff747ee3b05ae2526da5";
  });
  ...
  test("fetches and then renders the current weather and forecast", async () => {
    ...
    expect(window.fetch).toHaveBeenCalledWith(
      "https://api.openweathermap.org/data/2.5/weather/?q=Eldoret&units=metric&APPID=eeb11b133540ff747ee3b05ae2526da5"
    );
    expect(window.fetch).toHaveBeenCalledWith(
      "https://api.openweathermap.org/data/2.5/forecast/?q=Eldoret&units=metric&APPID=eeb11b133540ff747ee3b05ae2526da5"
    );
  });
