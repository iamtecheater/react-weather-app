...
function getWeather(city) {
  return fetch(
    `${'https://api.openweathermap.org/data/2.5'}/weather/?q=${city}&units=metric&APPID=${'eeb11b133540ff747ee3b05ae2526da5'}`
  )
...
function getForecast(city) {
  return fetch(
    `${'https://api.openweathermap.org/data/2.5'}/forecast/?q=${city}&units=metric&APPID=${'eeb11b133540ff747ee3b05ae2526da5'}`
  )
    .then(res => handleResponse(res))
    .then(result => {
